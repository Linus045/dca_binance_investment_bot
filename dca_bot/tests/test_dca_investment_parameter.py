...
from dca_investment_bot.dca_investment_parameter import DCAInvestmentParameter, InvalidParameterFormat, UnknownIntervalException
...
def test_constructor_invalid_symbol_throws_ValueError(parameter_symbol):
    ...
    with pytest.raises(ValueError):
        parameter = DCAInvestmentParameter(json_data)
...
def test_constructor_invalid_interval_throws_UnknownIntervalException(parameter_interval):
    json_data = {
        "symbol": "ETHUSDT",
        "investment_amount_quoteasset": 12,
...
@pytest.mark.parametrize("parameter_start_date", [True, 23, "test", "", "19:60", "19:72", "121231", "0000-23-23", "2021-12-32", "2021-02-29"])
def test_constructor_invalid_time_throws_InvalidParameterFormat(parameter_start_date):
    json_data = {
        "symbol": "ETHUSDT",
        "investment_amount_quoteasset": 12,
        "interval": "1w",
